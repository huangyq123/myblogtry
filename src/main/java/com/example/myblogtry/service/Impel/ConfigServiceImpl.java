...
import com.example.myblogtry.dao.BlogConfigMapper;
import com.example.myblogtry.entity.BlogConfig;
import com.example.myblogtry.service.ConfigService;
...
//        List<BlogConfig> configAll = blogConfigMapper.findConfigAll();
//        return configAll;

        //项目实现
        //获取所有的map并封装为map
        List<BlogConfig> blogConfigs = blogConfigMapper.findConfigAll();
